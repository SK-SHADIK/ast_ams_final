...
class AssetController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->transaction()->asset_price('Asset Price');
        $grid->transaction()->asset_purchase_request('Asset Purchase Request');
        $grid->transaction()->asset_purchase_order('Asset Purchase Order');
